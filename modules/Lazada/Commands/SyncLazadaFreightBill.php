...
class SyncLazadaFreightBill
{
    ...
    public function handle()
    {
        $orders = Order::query()->where([
            'marketplace_code' => Marketplace::CODE_LAZADA,
    ...
    protected function syncFreightBillStatus(FreightBill $freightBill)
    {
        ...
        if (!$status = Service::lazada()->mapFreightBillStatus($logisticsStatus)) {
    ...
    protected function getLogisticsStatus()
    {
        ...
        $logisticsMessage = Service::lazada()->api()->getLogisticsMessage([
