...
class ImportFreightBillStatus
{
    ...
    protected function validateData($rowInput, $line, &$freightBills = [])
    {
        ...
        if($rowInput['status'] != FreightBill::STATUS_RETURN) {
            $this->errors[] = [
                'line' => $line,
        ...
        $order = null;
        $freightBillStatus = [FreightBill::STATUS_CONFIRMED_PICKED_UP, FreightBill::STATUS_DELIVERING, FreightBill::STATUS_DELIVERED, FreightBill::STATUS_WAIT_FOR_PICK_UP];
    ...
    protected function processRow(array $row, $line)
    {
        ...
        foreach ($freightBills as $freightBill) {
            Service::freightBill()->changeStatus($freightBill, FreightBill::STATUS_RETURN, $this->user);
        }
