 ...
 */
class StorageFeeDailyByWarehouse
{
    /**
     * @var array
     */
    ...
    public function handle()
    {
        ...
        $query->select([]);
        $query->selectRaw('sku_id, warehouse_id, closing_time, SUM(fee) as fee, SUM(quantity) as quantity, SUM(volume) as volume');
        $query->groupByRaw('sku_id, warehouse_id, closing_time');
