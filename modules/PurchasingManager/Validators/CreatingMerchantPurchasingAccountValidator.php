...
class CreatingMerchantPurchasingAccountValidator extends Validator
{
    /** @var string|null */
    ...
    protected function customValidate()
    {
        ...
        if ($existPurchasingAccount) {
             ...
             * Khôi phục tài khoản
             */
            if ($existPurchasingAccount->deleted_at && $existPurchasingAccount->merchant_id == $this->user->merchant->id) {
