...
class ShopBaseUsApi implements ShopBaseUsApiInterface
{
    /**
     * @var
     */
    protected $apiUrl = 'onshopbase.com';
    ...
    {
        $this->apiUrl     = config('services.shopbaseus.api_url');
        $this->partnerId  = config('services.shopbaseus.client_id');
        $this->partnerKey = config('services.shopbaseus.client_secret');
        $this->http       = new Client();
        $this->logger     = LogService:: logger('shopbaseus-api');
    }

    /**
     * Lấy thông tin shop chi tiết từ ShopBaseUs
    ...
    /**
     * Lấy dữ liệu danh sách đơn từ ShopBaseUs
     * https://open.ShopBaseUs.vn/docs/docs/current/api-references/order-api-v2/#order-listing-v2
     *
     * @param array $params
     * @return RestApiResponse
     * @throws RestApiException
     ...
     * https://open.ShopBaseUs.vn/docs/docs/current/api-references/order-api-v2/#order-details-v2
     *
     * @param array $params
     * @return RestApiResponse
     * @throws RestApiException
    ...
    /**
     * Get List product
     * https://api-doc.shopbase.com/#tag/Product/operation/get-all-products
     *
     * @param array $params
     * @return RestApiResponse
     * @throws RestApiException
    ...
    /**
     * Get Detail Product From ShopBaseUs
     * 
     * 
     *
     * @param array $params
    ...
    /**
     * Get Logistics Message From ShopBaseUs
     * 
    ...
    /**
     * Update Product Stock From ShopBaseUs
     * 
    ...
    /**
     * Lấy Access Token ShopBaseUs bằng code ShopBaseUs trả về qua call back URL
     * https://open.ShopBaseUs.com/apps/doc/api?spm=a1zq7z.man108520.site_detail.1.3ae87c73rID2C8&path=%2Fauth%2Ftoken%2Fcreate
     *
     * @param array $params
     * @return RestApiResponse $respone
     * @throws RestApiException
    ...
    public function getAccessToken(array $params)
    {
        ...
        $paramsRequest = [
            ...
            // 'redirect_uri' => 'https://api.m28.gobizdev.com/marketplaces/SHOPBaseUs/oauth-callback',
            'app_key'         => config('services.shopBaseUs.client_id'),
            'app_secret'      => config('services.shopBaseUs.client_secret'),
        ];
        $respone = $this->request(config('services.shopBaseUs.authorization_uri') . '/api/v2/token/get', $paramsRequest, "GET");
        return $respone;
    }
    ...
    {
        $url = "https://{$clientId}:{$clientSecret}@{$shopName}.onshopbase.com/";
        return $url;
    }
