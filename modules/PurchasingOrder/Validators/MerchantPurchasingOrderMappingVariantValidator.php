...
class MerchantPurchasingOrderMappingVariantValidator extends Validator
{
    /** @var PurchasingOrder */
    ...
    protected function customValidate()
    {
        ...
        $purchasingOrderItemId = $this->input('item_id');
        $skuId                 = $this->input('sku_id');

        /** @var PurchasingOrderItem $purchasingOrderItem */
        $purchasingOrderItem = PurchasingOrderItem::find($purchasingOrderItemId);
        if (!$purchasingOrderItem) {
            $this->errors()->add('purchasing_order_item', 'exists');
            return;
        }
        $purchasingVariantId = $purchasingOrderItem->purchasing_variant_id;
