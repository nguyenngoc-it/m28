...
class UpdateSkuComboApiValidator extends Validator
{

    protected $merchant;
    protected $skuCombo;

    public function __construct(array $input = [], SkuCombo $skuCombo, Merchant $merchant)
    {
