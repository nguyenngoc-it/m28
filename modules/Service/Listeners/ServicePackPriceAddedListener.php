...
class ServicePackPriceAddedListener extends QueueableListener
{
    /**
     * @param ServicePackPriceAdded $event
     */
    public function handle(ServicePackPriceAdded $event)
    {
        ...
        $servicePack->logActivity(ServiceEvent::SERVICE_PACK_ADD_PRICE, $event->creator, [
